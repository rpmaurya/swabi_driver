...
const drawerTextColor = Color.fromRGBO(57, 64, 74, 1);
const drawerHeadingTextColor = Color.fromRGBO(35, 40, 46, 1);
...
const onRunningColor = Colors.amber;
const completedColor = Colors.indigoAccent;
