...
//   });
//
//   factory DriverBookingModel.fromJson(Map<String, dynamic> json) => DriverBookingModel(
...
//     pageable: json["pageable"].toString(),
...
//     numberOfElements: json["numberOfElements"].toString(),
//     first: json["first"].toString(),
//     empty: json["empty"].toString(),
//   );
//
//   Map<String, dynamic> toJson() => {
//     "content": List<String>.from(content!.map((x) => x.toJson())),
//     "pageable": pageable,
//     "totalPages": totalPages,
//     "totalElements": totalElements,
//     "last": last,
...
//     unpaged: json["unpaged"].toString(),
//     paged: json["paged"].toString(),
//   );
//
//   Map<String, dynamic> toJson() => {
//     "sort": sort,
...
//
//   factory Sort.fromJson(Map<String, dynamic> json) => Sort(
//     sorted: json["sorted"].toString(),
//     empty: json["empty"].toString(),
//     unsorted: json["unsorted"].toString(),
//   );
//
//   Map<String, dynamic> toJson() => {
//     "sorted": sorted,
