...
class Custom_ListTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        headingTitleReq?Text(headingTitle,
            style: loginTextStyle):const SizedBox.shrink(),
        Padding(
              ...
              child:Container(
                ...
                child: Row(
                  children: [
                    ...
                    child: Text(heading,style: custom_ListTileTextStyle,),
                    ),
                    const Spacer(),
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          child: Container(
            ...
            child: Row(
              children: [
                Image.asset(widget.img,height: 20,),
                Padding(padding:const EdgeInsets.symmetric(horizontal: 15),
                  child: Text(widget.heading,style: custom_ListTileTextStyle,),
                ),
                const Spacer(),
                widget.notification
              ],
